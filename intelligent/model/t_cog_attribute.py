...
class CogAttribute(ModelBase):

    def __init__(self):
        self.dbname='cognitive_phrases'
        super(CogAttribute,self).__init__(self.dbname)
    ...
    def addBrands(self, sBrand = '', sDeterminer = '', sFdeter = '' , sSource = 1, sThre = 0.5, sNoise = 1, sIndustry = -1):
        ...
        bRet = super(CogAttribute,self).operate(sSql)
        return bRet
    ...
    def queryAll(self):
        ...
        lRet = super(CogAttribute,self).query(sSql)
        return lRet
