...
class CogCategory(ModelBase):

    def __init__(self):
        self.dbname='cognitive_phrases'
        super(CogCategory,self).__init__(self.dbname)
        self.table = 'category'
    ...
    def addBrands(self, sBrand = '', sDeterminer = '', sFdeter = '' , sSource = 1, sThre = 0.5, sNoise = 1, sIndustry = -1):
        ...
        bRet = super(CogCategory,self).operate(sSql)
        return bRet
    ...
    def queryAll(self):
        ...
        lRet = super(CogCategory,self).query(sSql)
        return lRet
